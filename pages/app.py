...
def main():
    ...
    # Image analysis step
        ...
        js = "window.open('https://plant-sense--resanth18x.replit.app', '_blank')"
       ...
       # Voice input step
        ...
        js = "window.open('https://b18c3cfa-71ab-4ae9-9454-ed7179bc8147-00-2bdvtgzy9udhu.pike.replit.dev/', '_blank')"
        st.components.v1.html(f"<script>{js}</script>", height=0)
...
if st.button("Resource Agent"):
    js = f"window.open('https://5cd43a96-2ccf-4d0e-9bfb-a5b39df31448-00-1uaggu414d63t.pike.replit.dev/', '_blank')"
    st.components.v1.html(f"<script>{js}</script>", height=0)

if st.button("Bio digital twin"):
    js = f"window.open('https://farm-growth-visualizer--resanthsr.replit.app', '_blank')"
    st.components.v1.html(f"<script>{js}</script>", height=0)

if st.button("Open Crop Disease Detection Tool"):
    js = f"window.open('https://ai-crop-disease-dete-yjxk.bolt.host', '_blank')"
    st.components.v1.html(f"<script>{js}</script>", height=0)

if st.button("Weather Prediction"):
    js = f"window.open('https://99bbfe2d-d66d-4a0f-bbcf-7c96427e1e0a-00-2st9uhlrjciyf.janeway.replit.dev/', '_blank')"
    st.components.v1.html(f"<script>{js}</script>", height=0)

if st.button("PRICE TREND PREDICTOR"):
    js = f"window.open('https://agri-market-predict--vnirmalkumar200.replit.app', '_blank')"
    st.components.v1.html(f"<script>{js}</script>", height=0)



if st.button("Vendor Agent"):
    js = f"window.open('https://ai-market-agent--ammusarathi85.replit.app', '_blank')"
    st.components.v1.html(f"<script>{js}</script>", height=0)

if st.button("Report Genreator"):
    js = f"window.open('https://farm-operations-hub--sirichapochi101.replit.app', '_blank')"
    st.components.v1.html(f"<script>{js}</script>", height=0)
